...
//                                    $catalog_eav_attribute2->is_visible_in_advanced_search = $catalog_eav_attribute->is_visible_in_advanced_search;
            ...
            if($result['back_step'] == 'step2')
            {
                Yii::app()->user->setFlash('note', Yii::t('frontend', "You need at first migrate Websites and Stores, then you can move to any other Step."));
            } else {
                Yii::app()->user->setFlash('note', Yii::t('frontend', "The first you need to finish the %s.", array("%s" => ucfirst($result['back_step']))));
            }
...
//                                        }
            ...
            {
                Yii::app()->user->setFlash('note', Yii::t('frontend', "You need at first migrate Websites and Stores, then you can move to any other Step."));
            } else if ($result['back_step'] == 'step3'){
                Yii::app()->user->setFlash('note', Yii::t('frontend', "In order to migrate products you have to first migrate the product attributes."));
            } else {
                Yii::app()->user->setFlash('note', Yii::t('frontend', "The first you need to finish the %s.", array("%s" => ucfirst($result['back_step']))));
            }
                                                                    ...
                                                                    if ($model2->save()){
                                                                        ...
                                                                        if (in_array($attribute_code1, $needed_update_attr2)){
                                                                            if ($address_entity2->hasAttribute($attribute_code1)){
                                                                                ...
                                                                                if(!$model->value) {
                                                                                    $address_entity2->$attribute_code1 = 'unknown';
                                                                                }
