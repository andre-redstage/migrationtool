...
<div id="message" class="flash-notice">
    This step migrates all orders from guest customers and all orders from customers imported on step 6. So in order to have all orders imported, import all customers as well.
</div>
<?php
